...
<asp:Content ID="Content3" ContentPlaceHolderID="cntDetails" Runat="Server">
        <!-- Pages_buttons -->
    <div id="section-bar">
        <span class="btn"><a href="EditSolution.aspx?act=new" title="+ Add">+ Add</a></span>
    </div>
    <!-- /Pages_buttons -->
    ...
    <div style="clear: both"><asp:Label runat="server" ID="lblError" ForeColor="Red"></asp:Label></div>
         ...
         <Columns>
             ...
             <asp:TemplateField HeaderText="Name" SortExpression="Name">
              ...
              <asp:TemplateField HeaderText="">
                 ...
                 <ItemTemplate>
                     <span class="btn-edit"><a href='EditSolution.aspx?Id=<%# Eval("Id") %>&act=edit' title="Edit">Edit</a></span>
                     <asp:LinkButton runat="server" OnClientClick="confirm('Bạn có chắt xóa giải pháp này?')" OnCommand="lbtnDelete_Command" ID="lbtnDelete" CommandArgument='<%# Eval("Id") %>' Text ="Delete" CssClass="btn-delete"></asp:LinkButton>
                 </ItemTemplate>
                 <ControlStyle CssClass="admin-table-titles admin-table-field" />
             </asp:TemplateField>
         </Columns>
     ...
     <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DataContentDataContext" EntityTypeName="" Select="new (ID, Header)" TableName="Solutions">
     </asp:LinqDataSource>
