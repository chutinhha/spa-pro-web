<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="SolutionDetails.aspx.cs" Inherits="Solution" %>
                                                                ...
                                                                <div class="wrapper row-1">
                                                                    ...
                                                                    <div class="col-2">
                                                                        ...
                                                                        <div class="wrapper p1">
                                                                            <img class="img-left" src='<%=objSolution.Link_Image_Small.Replace("~/","") %>' alt="" />
                                                                            <h3><%=objSolution.Name %></h3>
                                                                            <%=objSolution.Header %>
                                                                            <div class="clr"></div>
                                                                            <%=objSolution.Contents %>
                                                                        </div>
