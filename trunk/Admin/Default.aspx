        ...
        <tbody class="admin-table-content">
            <tr style="background: #F2F2F2;" class="admin-table-tr">
                ...
                <td class="admin-table-field" align="right">
                    <span class="btn-edit"><a href="EditAboutUs.aspx" title="Edit">Edit</a></span> 
                    <%--<span
                        class="btn-delete"><a href="#" title="Delete" onclick="return confirmDelete('Delete')">
                            Delete</a></span>--%>
                </td>
            </tr>
            <tr style="background: #F2F2F2;" class="admin-table-tr">
                ...
                <td class="admin-table-field" align="right">
                    <span class="btn-edit"><a href=""
                        title="Edit">Edit</a></span> <%--<span class="btn-delete-disable"><a href="" title="Delete">
                            Delete</a></span>--%>
                </td>
            </tr>
            <tr style="background: #F2F2F2;" class="admin-table-tr">
                ...
                <td class="admin-table-field" align="right">
                    <span class="btn-edit"><a href="EditHome.aspx"
                        title="Edit">Edit</a></span><%-- <span class="btn-delete"><a href="#" title="Delete"
                            onclick="return confirmDelete('Delete')">Delete</a></span>--%>
                </td>
            </tr>
        </tbody>
    </table>
